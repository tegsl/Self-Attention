...
#ifndef VERILATED_VSELF_ATTENTION_H_
#define VERILATED_VSELF_ATTENTION_H_  // guard

#include "verilated.h"

class Vself_attention__Syms;
class Vself_attention___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vself_attention VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vself_attention___024root* const rootp;
    ...
    explicit Vself_attention(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vself_attention(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vself_attention();
  private:
    VL_UNCOPYABLE(Vself_attention);  ///< Copying not allowed
